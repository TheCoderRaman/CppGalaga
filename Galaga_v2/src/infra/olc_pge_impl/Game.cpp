...
static void updateAndDraw(ol::SceneManager& sceneManager, ol::Renderer& renderer)
{
...
static void updateKeyStates(OlcPgeWindow* olcPgeWindow);
...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		updateAndDraw(sceneManager, renderer);
		return true;
	}
...
static void updateKeyStates(OlcPgeWindow* olcPgeWindow)
{
    for (auto const& key : keyMap)
    {
        ...
        olc::HWButton keyState = olcPgeWindow->GetKey(olcKey);
